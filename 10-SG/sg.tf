...
#eks control plane accepting traffic from node
...
#eks control plane is accepting traffic from bastion
...
#nodes accepting traffic from eks control plane
...
#eks nodes accepting from alb_ingress
...
#nodes are accepting traffic from vpc CIDR
...
#nodes are accepting traffic from bastion
...
#alb ingress accepting traffic from bastion on https
...
#app alb accepting traffic from public on https
...
#mysql should accept traffic from bastion
...
#mysql should accept traffic from eks nodes
